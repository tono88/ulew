...
class PosConfig(models.Model):
    _inherit = 'pos.config'
    product_details_data = fields.Many2many("product.pricelist.item","product.fields", "pods_config_product_settings_relation", "pos_config_id", "product_setings_id", string="POS Product Detail", compute='_get_config_settings')
